...
class HukumLampiran extends Model
{
    use HasFactory;

    protected $table = 'hukum_lampirans';
    ...
    // Relasi ke model Hukum
    public function hukum()
    {
        return $this->belongsTo(Hukum::class);
    }
    ...
    // Scope untuk filter berdasarkan hukum_id
    public function scopeByHukum($query, $hukumId)
    {
        return $query->where('hukum_id', $hukumId);
    }
