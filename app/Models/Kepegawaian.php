...
class Kepegawaian extends Model
{
    ...
    {
        $this->attributes['label_input_1'] = $value ?: 'Jumlah Proses Kepegawaian';
    }
    ...
    {
        return $value ?: 'Jumlah Proses Kepegawaian';
    }
    ...
    {
        return $this->label_input_1 ?: 'Jumlah Proses Kepegawaian';
    }
