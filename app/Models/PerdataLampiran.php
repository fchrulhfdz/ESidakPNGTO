...
class PerdataLampiran extends Model
{
    use HasFactory;

    protected $table = 'perdata_lampirans';
    ...
    // Relasi ke model Perdata
    public function perdata()
    {
        return $this->belongsTo(Perdata::class);
    }
    ...
    // Scope untuk filter berdasarkan perdata_id
    public function scopeByPerdata($query, $perdataId)
    {
        return $query->where('perdata_id', $perdataId);
    }
