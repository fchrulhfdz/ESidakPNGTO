...
class TipikorLampiran extends Model
{
    use HasFactory;

    protected $table = 'tipikor_lampirans';
    ...
    // Relasi ke model Tipikor
    public function tipikor()
    {
        return $this->belongsTo(Tipikor::class);
    }
    ...
    // Scope untuk filter berdasarkan tipikor_id
    public function scopeByTipikor($query, $tipikorId)
    {
        return $query->where('tipikor_id', $tipikorId);
    }
