...
class PhiLampiran extends Model
{
    use HasFactory;

    protected $table = 'phi_lampirans';
    ...
    public function phi()
    {
        return $this->belongsTo(Phi::class);
    }
    ...
    // Scope untuk filter berdasarkan phi_id
    public function scopeByPhi($query, $phiId)
    {
        return $query->where('phi_id', $phiId);
    }
