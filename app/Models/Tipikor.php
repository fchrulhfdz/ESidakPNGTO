...
class Tipikor extends Model
{
    ...
    public function getDisplayLabelInput1Attribute()
    {
        ...
        if ($this->tipe_input === 'dua_input') {
            return 'Jumlah Perkara Tipikors Diselesaikan';
        } else {
            return 'Jumlah Perkara Tipikors';
        }
    }
    ...
    {
        if ($this->tipe_input === 'dua_input') {
            return $this->label_input_2 ?: 'Jumlah Perkara Tipikors Tepat Waktu';
        }
    ...
    public function getSafeLabelInput1()
    {
        ...
        return $this->tipe_input === 'dua_input' ? 'Jumlah Perkara Tipikors Diselesaikan' : 'Jumlah Perkara Tipikors';
    }
    ...
    {
        return $this->hasMany(TipikorLampiran::class);
    }
