...
class Tipikor extends Model
{
    use HasFactory;

    protected $table = 'tipikor';
    ...
    // Mutator untuk label input dengan nilai default untuk Tipikor
    public function setLabelInput1Attribute($value)
    {
        $this->attributes['label_input_1'] = $value ?: 'Jumlah Perkara Tipikor Diselesaikan';
    }

    public function setLabelInput2Attribute($value)
    {
        $this->attributes['label_input_2'] = $value ?: 'Jumlah Perkara Tipikor Tepat Waktu';
    }

    // Accessor untuk label input (jika kosong, berikan nilai default untuk Tipikor)
    public function getLabelInput1Attribute($value)
    {
        return $value ?: 'Jumlah Perkara Tipikor Diselesaikan';
    }

    public function getLabelInput2Attribute($value)
    {
        return $value ?: 'Jumlah Perkara Tipikor Tepat Waktu';
    }
    ...
    public function scopeTipikor($query)
    {
        return $query->where('jenis', 'tipikor');
    }
    ...
    // Method untuk mendapatkan label input yang aman (tidak null) untuk Tipikor
    public function getSafeLabelInput1()
    {
        return $this->label_input_1 ?: 'Jumlah Perkara Tipikor Diselesaikan';
    }

    public function getSafeLabelInput2()
    {
        return $this->label_input_2 ?: 'Jumlah Perkara Tipikor Tepat Waktu';
    }
