...
class Pidana extends Model
{
    ...
    public function getDisplayLabelInput1Attribute()
    {
        ...
        if ($this->tipe_input === 'dua_input') {
            return 'Jumlah Perkara Pidana Diselesaikan';
        } else {
            return 'Jumlah Perkara Pidana';
        }
    }
    ...
    {
        if ($this->tipe_input === 'dua_input') {
            return $this->label_input_2 ?: 'Jumlah Perkara Pidana Tepat Waktu';
        }
    ...
    public function getSafeLabelInput1()
    {
        ...
        return $this->tipe_input === 'dua_input' ? 'Jumlah Perkara Pidana Diselesaikan' : 'Jumlah Perkara Pidana';
    }
    ...
    {
        return $this->hasMany(PidanaLampiran::class);
    }
