...
class Perdata extends Model
{
    ...
    public function getDisplayLabelInput1Attribute()
    {
        ...
        if ($this->tipe_input === 'dua_input') {
            return 'Jumlah Perkara Diselesaikan';
        } else {
            return 'Jumlah Perkara';
        }
    }
    ...
    public function getSafeLabelInput1()
    {
        ...
        return $this->tipe_input === 'dua_input' ? 'Jumlah Perkara Diselesaikan' : 'Jumlah Perkara';
    }
    ...
    {
        return $this->hasMany(PerdataLampiran::class);
    }
