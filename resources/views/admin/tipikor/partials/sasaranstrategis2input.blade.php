<div class="bg-white rounded-2xl border border-gray-200 p-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-lg font-semibold text-gray-900">Tambah Sasaran Strategis Baru (2 Input)</h2>
    </div>
    
    <form action="{{ route('store.perkara') }}" method="POST" id="formTambahSasaran2Input">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <!-- Input Label untuk Input 1 dan Input 2 -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
