...
<div class="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
    ...
    <form id="uploadLampiranForm" enctype="multipart/form-data">
        @csrf
        <div class="space-y-6">
            <!-- Filter untuk Data Tipikor -->
            <div class="bg-gray-50 rounded-xl p-4 mb-4">
                <h4 class="text-sm font-medium text-gray-700 mb-3">Filter Data Tipikor</h4>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Pilih Data Tipikor</label>
                <select name="parent_id" id="lampiranTipikorSelect" required
                    ...
                    <option value="">Pilih Data Tipikor</option>
