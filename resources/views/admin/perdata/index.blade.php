...
<div class="container mx-auto px-4 py-8">
    ...
    <!-- Include Navigation -->
    @include('admin.perdata.partials.nav_perdata')
    ...
    <div id="sasaranContent1Input" class="tab-content hidden">
        @include('admin.perdata.partials.sasaranstrategis1input')
    </div>
    @endif

    <!-- Tab Content: Lampiran PDF -->
    <div id="lampiranContent" class="tab-content hidden">
        @include('admin.perdata.partials.lampiran')
    </div>
    ...
    <div id="editModal" class="fixed inset-0 bg-black bg-opacity-40 overflow-y-auto h-full w-full hidden z-50 transition-opacity duration-300 flex items-center justify-center p-4">
        <div class="relative bg-white rounded-2xl border border-gray-200 w-full max-w-2xl transform transition-all duration-300 scale-95">
            <div class="p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4" id="editModalTitle">Edit Data Perkara</h3>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.edit-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.getElementById('editModalTitle').textContent = userType === 'superadmin' 
                    ? 'Edit Data Perkara (Super Admin)' 
                    : 'Edit Data Perkara (Admin)';
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    tableBody.innerHTML = data.map(lampiran => {
                        ...
                        const capaian = lampiran.perdata ? lampiran.perdata.capaian : null;
                        let capaianDisplay = '-';
                        let capaianClass = '';
                        ...
                        return `
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <a href="/perdata/lampiran/${lampiran.id}/download" 
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    ${lampiran.perdata ? lampiran.perdata.indikator_kinerja : '-'}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    ${lampiran.perdata ? lampiran.perdata.sasaran_strategis : '-'}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    ${lampiran.perdata ? lampiran.perdata.nama_bulan + ' ' + lampiran.perdata.tahun : '-'}
                                </td>
        ...
        document.getElementById('filterLampiranBtn')?.addEventListener('click', function() {
            ...
            const options = document.querySelectorAll('#lampiranPerdataSelect option');
            options.forEach(option => {
                ...
                if (matchBulan && matchTahun && matchIndikator) {
                    ...
                    if (option.selected) {
                        ...
                        document.getElementById('lampiranPerdataSelect').value = '';
        ...
        document.getElementById('lampiranPerdataSelect')?.addEventListener('change', function() {
