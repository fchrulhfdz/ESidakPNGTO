...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900">Perkara Hukum</h1>
            <p class="text-gray-600 mt-1">Kelola data perkara hukum dan capaian kinerja</p>
        </div>
        @if(auth()->user()->isSuperAdmin())
            <span class="bg-green-50 text-green-700 px-3 py-1.5 rounded-lg text-sm font-medium border border-green-100">Super Admin</span>
        @else
            <span class="bg-teal-50 text-teal-700 px-3 py-1.5 rounded-lg text-sm font-medium border border-teal-100">Admin Hukum</span>
        @endif
    </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-4 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <select id="filterBulan" class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 bg-white">
                ...
                <div>
                    ...
                    <select id="filterTahun" class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 bg-white">
                ...
                <div class="flex items-end">
                    <button id="cariBtn" class="w-full bg-green-600 text-white px-6 py-2.5 rounded-lg hover:bg-green-700 transition duration-200 font-medium">
                        Cari
                    </button>
                </div>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button id="toggleAll" class="text-sm text-green-600 hover:text-green-800 font-medium transition-colors duration-150">Buka Semua</button>
                </div>
            </div>
                    ...
                    <div class="accordion-content hidden px-6 pb-5">
                        ...
                        <div class="mt-5 pt-4 border-t border-gray-200 flex justify-between items-center">
                            ...
                            <div class="flex space-x-3">
                                <button type="button" class="text-green-600 hover:text-green-800 text-sm font-medium edit-btn transition-colors duration-150" 
                                        data-id="{{ $item->id }}"
    ...
    <div id="inputContent" class="tab-content hidden">
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            <h2 class="text-lg font-semibold text-gray-900 mb-6">Input Data Perhitungan Hukum</h2>
            ...
            <form id="formInputData" action="{{ route('store.perkara') }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="bulan" id="bulan" required
                                    class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 bg-white">
                                <option value="">Pilih Bulan</option>
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                        <h3 class="text-sm font-medium text-green-800 mb-3">Hasil Perhitungan</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-xs text-green-700 mb-1 font-medium">Realisasi</label>
                                <input type="text" id="realisasi" readonly
                                       class="w-full px-3 py-2.5 border border-green-300 rounded-lg bg-white text-center font-semibold text-green-800"
                                       value="{{ old('realisasi') }}">
                            </div>
                            
                            <div>
                                <label class="block text-xs text-green-700 mb-1 font-medium">Capaian</label>
                    ...
                    <div class="flex justify-between items-center pt-2">
                        <button type="button" id="hitungBtn" 
                                class="bg-green-600 text-white px-6 py-2.5 rounded-lg hover:bg-green-700 transition duration-200 flex items-center font-medium">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="label_input_1" required
                               ...
                               placeholder="Contoh: Jumlah Perkara Hukum Diselesaikan">
                        @error('label_input_1')
                            <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="label_input_2" required
                               ...
                               placeholder="Contoh: Jumlah Perkara Hukum Tepat Waktu">
                        @error('label_input_2')
                            <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>
        ...
        <div class="p-6">
            ...
            <form id="editForm" method="POST">
                ...
                <div class="space-y-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="sasaran_strategis" id="edit_sasaran" required
                               class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200">
                    </div>
                ...
                <div class="flex justify-end space-x-3 mt-6">
                    ...
                    <button type="submit" 
                            class="px-4 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition duration-200 font-medium">
                        Update
                    </button>
                </div>
            </form>
