...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-600 mt-1">Kelola data perkara penyelesaian hubungan industrial dan capaian kinerja</p>
        </div>
        ...
        @else
            <span class="bg-purple-50 text-purple-700 px-3 py-1.5 rounded-lg text-sm font-medium border border-purple-100">Admin PHI</span>
        @endif
    </div>
