...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900">Perkara PHI</h1>
            <p class="text-gray-600 mt-1">Kelola data perkara hubungan industrial dan capaian kinerja</p>
        </div>
        ...
        @else
            <span class="bg-indigo-50 text-indigo-700 px-3 py-1.5 rounded-lg text-sm font-medium border border-indigo-100">Admin PHI</span>
        @endif
    </div>
    ...
    <div id="dataContent" class="tab-content active">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h2 class="text-lg font-semibold text-gray-900">Data Perkara PHI</h2>
    ...
    <div id="inputContent" class="tab-content hidden">
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            <h2 class="text-lg font-semibold text-gray-900 mb-6">Input Data Perhitungan PHI</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="label_input_1" required
                               ...
                               placeholder="Contoh: Jumlah Perkara PHI Diselesaikan">
                        @error('label_input_1')
                            <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="label_input_2" required
                               ...
                               placeholder="Contoh: Jumlah Perkara PHI Tepat Waktu">
                        @error('label_input_2')
                            <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
                        @enderror
                    </div>
