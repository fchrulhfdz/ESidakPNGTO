...
<div class="container mx-auto px-4 py-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="label_input_1" required
                                   ...
                                   placeholder="Contoh: Jumlah Kegiatan Kepegawaian">
                            @error('label_input_1')
                                <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
                            @enderror
                        </div>
    ...
    <div id="inputContent" class="tab-content hidden">
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            ...
            <form action="{{ route('store.kepegawaian') }}" method="POST">
                @csrf
                <input type="hidden" name="jenis" value="kepegawaian">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (kepegawaianSelect) {
        kepegawaianSelect.addEventListener('change', function() {
        ...
        if (kepegawaianSelect.value) {
            kepegawaianSelect.dispatchEvent(new Event('change'));
        }
    }
    ...
    document.querySelectorAll('.edit-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            document.getElementById('editForm').action = `/kepegawaian/${id}`;
