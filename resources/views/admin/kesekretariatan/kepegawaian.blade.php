...
@section('title', 'Kepegawaian - E-SIDAK')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900">Kepegawaian</h1>
            <p class="text-gray-600 mt-1">Kelola data kepegawaian dan lampiran</p>
        </div>
        ...
        @else
            <span class="bg-emerald-50 text-emerald-700 px-3 py-1.5 rounded-lg text-sm font-medium border border-emerald-100">Admin Kepegawaian</span>
        @endif
    </div>
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex items-center mt-2 space-x-4">
                                    ...
                                    @if($item->input_1 !== null)
                                        <span class="text-xs text-gray-500">Jumlah Pegawai: {{ $item->input_1 }}</span>
                                    @endif
                    ...
                    <div class="accordion-content hidden px-6 pb-5">
                        <div class="mt-4">
                            ...
                            <dl class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div>
                                    <dt class="text-xs text-gray-500 font-medium">Jumlah Pegawai</dt>
                        ...
                        <div class="mt-5 pt-4 border-t border-gray-200 flex justify-between items-center">
                            ...
                            <div class="flex space-x-3">
                                {{-- Tombol Edit untuk Super Admin dan Admin Kepegawaian --}}
                                @if(auth()->user()->isSuperAdmin() || auth()->user()->role == 'kepegawaian')
                                <button type="button" class="text-blue-600 hover:text-blue-800 text-sm font-medium edit-btn transition-colors duration-150" 
                                        data-id="{{ $item->id }}"
                                        data-jenis="kepegawaian">
                                    Edit
                                </button>
                                @endif
                                ...
                                @if(auth()->user()->isSuperAdmin())
                                <form action="{{ route('kepegawaian.destroy', $item->id) }}" method="POST" class="inline delete-form">
                                    @csrf
                                    @method('DELETE')
    ...
    <div id="sasaranContent" class="tab-content hidden">
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            ...
            <form action="{{ route('store.kepegawaian') }}" method="POST" id="formTambahSasaran">
                @csrf
                <input type="hidden" name="jenis" value="kepegawaian">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="sasaran_strategis" required
                               ...
                               placeholder="Contoh: Meningkatkan Kinerja Pegawai">
                    ...
                    <div>
                        ...
                        <input type="text" name="indikator_kinerja" required
                               ...
                               placeholder="Contoh: Persentase pegawai yang mengikuti pelatihan">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="label_input_1" required
                                   ...
                                   placeholder="Contoh: Jumlah Pegawai">
                            @error('label_input_1')
                                <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
                            @enderror
                        </div>
    ...
    <div id="inputContent" class="tab-content hidden">
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
            <h2 class="text-lg font-semibold text-gray-900 mb-6">Input Data Kepegawaian</h2>
            
            <form action="{{ route('store.kepegawaian') }}" method="POST" id="inputDataForm">
                @csrf
                <input type="hidden" name="jenis" value="kepegawaian">
                ...
                <div class="space-y-6">
                    ...
                    <div id="existing_sasaran_form">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Indikator Kinerja</label>
                            <select name="parent_id" id="kepegawaianSelect" required
                                    class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">
                            <span id="label_input_1_display">Jumlah Pegawai</span>
                        </label>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="hambatan" id="hambatan" rows="3"
                                          ...
                                          placeholder="Jelaskan hambatan dalam pengelolaan kepegawaian">{{ old('hambatan') }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="rekomendasi" id="rekomendasi" rows="3"
                                          class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white resize-none"
                                          placeholder="Berikan rekomendasi untuk perbaikan pengelolaan kepegawaian">{{ old('rekomendasi') }}</textarea>
                                <p class="text-xs text-gray-500 mt-1">Opsional. Maksimal 2000 karakter.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="keberhasilan" id="keberhasilan" rows="3"
                                          class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white resize-none"
                                          placeholder="Jelaskan keberhasilan dalam pengelolaan kepegawaian">{{ old('keberhasilan') }}</textarea>
                                <p class="text-xs text-gray-500 mt-1">Opsional. Maksimal 2000 karakter.</p>
                            </div>
                        </div>
                    </div>
    ...
    <div id="lampiranContent" class="tab-content hidden">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-6">
            ...
            <form id="uploadLampiranForm" enctype="multipart/form-data">
                @csrf
                <div class="space-y-6">
                    <!-- Filter untuk Data Kepegawaian -->
                    <div class="bg-gray-50 rounded-xl p-4 mb-4">
                        <h4 class="text-sm font-medium text-gray-700 mb-3">Filter Data Kepegawaian</h4>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Bulan</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Pilih Data Kepegawaian</label>
                        <select name="parent_id" id="lampiranKepegawaianSelect" required
                                class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white">
                            <option value="">Pilih Data Kepegawaian</option>
...
<div id="editModal" class="fixed inset-0 bg-black bg-opacity-40 overflow-y-auto h-full w-full hidden z-50 transition-opacity duration-300 flex items-center justify-center p-4">
    <div class="relative bg-white rounded-2xl border border-gray-200 w-full max-w-2xl transform transition-all duration-300 scale-95">
        <div class="p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">Edit Data Kepegawaian</h3>
            <form id="editForm" method="POST">
                @csrf
                @method('PUT')
                <input type="hidden" name="jenis" id="edit_jenis" value="kepegawaian">
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            <label class="block text-sm font-medium text-gray-700">
                                <span id="edit_label_input_1_display">Jumlah Pegawai</span>
                            </label>
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="hambatan" id="edit_hambatan" rows="2"
                                      ...
                                      placeholder="Jelaskan hambatan dalam pengelolaan kepegawaian"></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="keberhasilan" id="edit_keberhasilan" rows="2"
                                      class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 resize-none"
                                      placeholder="Jelaskan keberhasilan dalam pengelolaan kepegawaian"></textarea>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const kepegawaianSelect = document.getElementById('kepegawaianSelect');
    ...
    function updateDisplayFields() {
        const selectedOption = kepegawaianSelect.options[kepegawaianSelect.selectedIndex];
        if (selectedOption.value) {
            ...
            document.getElementById('label_input_1_display').textContent = 'Jumlah Pegawai';
        }
    }
    
    if (kepegawaianSelect) {
        kepegawaianSelect.addEventListener('change', updateDisplayFields);
        if (kepegawaianSelect.value) {
            updateDisplayFields();
        }
    }
    ...
    function populateEditModal(data, capaianData, isSuperAdmin) {
        ...
        if (isSuperAdmin) {
            ...
            document.getElementById('edit_label_input_1_display').textContent = data.label_input_1 || 'Jumlah Pegawai';
    ...
    document.querySelectorAll('.edit-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            const jenis = this.getAttribute('data-jenis') || 'kepegawaian';
    ...
    if (cariBtn) {
        cariBtn.addEventListener('click', filterDataKepegawaian);
    }
    ...
    const lampiranKepegawaianSelect = document.getElementById('lampiranKepegawaianSelect');
    ...
    function filterLampiranOptions() {
        ...
        Array.from(lampiranKepegawaianSelect.options).forEach(option => {
        ...
        const selectedOption = lampiranKepegawaianSelect.options[lampiranKepegawaianSelect.selectedIndex];
        if (selectedOption && selectedOption.style.display === 'none') {
            lampiranKepegawaianSelect.value = '';
        ...
        if (!hasVisibleOptions && lampiranKepegawaianSelect.options.length > 1) {
            if (!filterMessage) {
                const message = document.createElement('p');
                message.id = 'filterLampiranMessage';
                message.className = 'text-sm text-amber-600 mt-2';
                message.textContent = 'Tidak ada data Kepegawaian yang sesuai dengan filter yang dipilih.';
                lampiranKepegawaianSelect.parentNode.appendChild(message);
            }
    ...
    // Event listener untuk perubahan pilihan data Kepegawaian
    if (lampiranKepegawaianSelect) {
        lampiranKepegawaianSelect.addEventListener('change', function() {
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                tableBody.innerHTML = data.map(lampiran => {
                    ...
                    const capaian = lampiran.kepegawaian ? lampiran.kepegawaian.capaian : null;
                    let capaianDisplay = '-';
                    let capaianClass = '';
                    ...
                    return `
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <a href="/kepegawaian/lampiran/${lampiran.id}/download" 
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                ${lampiran.kepegawaian ? lampiran.kepegawaian.indikator_kinerja : '-'}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                ${lampiran.kepegawaian ? lampiran.kepegawaian.sasaran_strategis : '-'}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                ${lampiran.kepegawaian ? lampiran.kepegawaian.nama_bulan + ' ' + lampiran.kepegawaian.tahun : '-'}
                            </td>
