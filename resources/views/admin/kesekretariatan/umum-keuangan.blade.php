...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Data Kesekretariatan Umum & Keuangan</h1>
        @if(auth()->user()->isSuperAdmin())
            <span class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium">Super Admin Mode</span>
        @else
            <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-medium">Admin Umum & Keuangan</span>
        @endif
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <form action="{{ route('store.kesekretariatan') }}" method="POST" id="formTambahSasaran">
            @csrf
            <input type="hidden" name="jenis" value="umum_keuangan">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Data Kesekretariatan Umum & Keuangan</h2>
        ...
        <div class="text-center py-12">
            <p class="text-gray-500 text-lg">Belum ada data kesekretariatan umum & keuangan</p>
        </div>
        @endif
    </div>
</div>
