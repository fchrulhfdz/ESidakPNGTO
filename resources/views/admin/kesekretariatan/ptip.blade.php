...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        @else
            <span class="bg-emerald-50 text-emerald-700 px-3 py-1.5 rounded-lg text-sm font-medium border border-emerald-100">Admin PTIP</span>
        @endif
    </div>
                    ...
                    <div class="accordion-content hidden px-6 pb-5">
                        ...
                        <div class="mt-5 pt-4 border-t border-gray-200 flex justify-between items-center">
                            ...
                            <div class="flex space-x-3">
                                {{-- Tombol Edit untuk Super Admin dan Admin PTIP --}}
    ...
    <div class="relative bg-white rounded-2xl border border-gray-200 w-full max-w-2xl transform transition-all duration-300 scale-95">
        <div class="p-6">
            ...
            <form id="editForm" method="POST">
                @csrf
                @method('PUT')
                <input type="hidden" name="jenis" id="edit_jenis" value="ptip">
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                tableBody.innerHTML = data.map(lampiran => {
                    ...
                    const capaian = lampiran.ptip ? lampiran.ptip.capaian : null;
                    let capaianDisplay = '-';
                    let capaianClass = '';
